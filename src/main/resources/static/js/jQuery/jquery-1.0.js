...
jQuery.fn = jQuery.prototype = {
    ...
    append: function() {
        return thismManip(arguments, true, 1, function(a){
            this.appendChild( a );
        });
    },
    prepend: function() {
    ...
    before: function() {
        return thismManip(arguments, false, 1, function(a){
    ...
    event: {
        ...
        trigger: function(type,data,element) {
            ...
            if ( !element ) {
                ...
                data.unshift( this.fix({ type: type: element }) );
